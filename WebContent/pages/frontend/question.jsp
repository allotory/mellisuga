...
<head>
<meta charset="utf-8">
<title>程序员工作中的 80/20 法则如何体现？ - 解惑</title>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbar-main">
				...
				<form class="navbar-form navbar-left">
					<input type="text" size="50" class="form-control col-lg-8"
						placeholder="Search">
				</form>
		...
		<div class="page-content">
			<div class="row">
				<div class="col-lg-8 col-md-7 col-sm-6">
					<div class="q-main">
						<div class="q-tag">
							<span class="label label-primary">程序员</span>
							<span class="label label-primary">前端</span> 
							<span class="label label-primary">Web</span> 
							<a href="#" class="glyphicon glyphicon-pencil meta-item-edit">修改</a>
						</div>
						<div class="q-title">
						...
						<div class="q-content">
							在工作学习中你们是如何分配时间的，需要苦练的那20%的技能应该是什么？<br>
							80/20法则，是按事情的重要程度编排行事优先次序的准则是建立在“重要的少数与琐碎的多数”原理的基础上<br>
							重要的因子通常只占少数，而不重要的因子则占多数，因此只要能控制具有重要性的少数因子即能控制全局. 
							<a href="#" class="glyphicon glyphicon-pencil meta-item-edit">修改</a>
						</div>
						<div class="q-feed-meta">
							<a href="#" class="meta-item glyphicon glyphicon-comment">添加评论</a>
							<a href="#" class="meta-item glyphicon glyphicon-share">分享</a> 
							<span class="zg-bull">•</span> 
							<a href="#" class="meta-item">邀请回答</a>
							<a href="#" class="meta-item-right glyphicon glyphicon-flag">举报</a>
						</div>
					</div>
							...
							<div class="col-lg-11 col-md-11 col-sm-11">
								<div class="feed-main">
									...
									<div class="content">
										...
										<div class="feed-meta">
											<a href="#" class="answer-date-link">发布于 18:14 </a> <a
												href="#" class="meta-item glyphicon glyphicon-comment">添加评论</a>
							...
							<div class="col-lg-11 col-md-11 col-sm-11">
								<div class="post-main">
									<div class="post-source">
										<a href="#" target="_blank" class="zg-link">Kenneth</a>
									</div>
									<div class="content">
				...
				<div class="col-lg-3 col-md-offset-1">
					<div class="follow-btn col-lg-12">
						<a href="#" class="btn btn-primary">关注</a>
							<div class="btn-group">
								<a href="#" class="btn btn-default">操作</a> 
					...
					<div class="sidebar-group">
						<span class="sidebar-title">相关问题</span>
						<div class="similar-q">
							<a>起草劳动合同容易犯的错误有哪些，能否举例说明？</a> 9 个回答
						</div>
						<div class="similar-q">
							<a>起草劳动合同容易犯的错误有哪些，能否举例说明？</a> 9 个回答
						</div>
					...
					<div class="sidebar-group">
						<span class="sidebar-title">分享问题</span>
						<div class="sidebar-share">
							<a href="" class="q-share glyphicon glyphicon-share">新浪微博</a> 
							<a href="" class="q-share glyphicon glyphicon-envelope">站内私信</a>
						</div>
					</div>
